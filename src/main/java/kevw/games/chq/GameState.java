...
import kevw.games.chq.TurnListener;
import kevw.games.chq.GameStateEvent;
import kevw.games.chq.GameStateListener;

public class GameState  {
	Player players[];
	private transient ArrayList<GameStateListener> gameStateListeners = new ArrayList<GameStateListener>(2);
	private transient ArrayList<TurnListener> gameClockListeners = new ArrayList<TurnListener>(2);
